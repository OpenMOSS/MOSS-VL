...
```bash
python inference/offline/run_inference.py \
  --checkpoint /path/to/dummy-checkpoint \
  --mode offline \
  --input inference/offline/image_queries.json
```
...
python inference/offline/run_inference.py \
  --checkpoint /path/to/dummy-checkpoint \
  --mode offline \
  --input inference/offline/video_queries.json
```
...
python inference/offline/run_inference.py \
  --checkpoint /path/to/dummy-checkpoint \
  --mode offline \
  --input inference/offline/batch_queries.json
```
