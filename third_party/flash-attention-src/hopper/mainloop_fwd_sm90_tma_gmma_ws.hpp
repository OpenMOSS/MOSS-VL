...
struct CollectiveMainloopFwdSm90 {
    ...
    to_underlying_arguments(Arguments const& args) {
        ...
        return {args.ptr_Q, args.shape_Q, args.stride_Q, shape_Q_packed, stride_Q_packed,
                ...
                args.seqused_q, args.seqused_k, args.leftpad_k, args.seqlens_rotary, args.cross_kv_boundary};
    }
    ...
    load(Params const& params,
        ...
        auto [n_block_min, n_block_max] = BlockMN_t::get_n_block_min_max(
            ...
            params.qhead_per_khead_divmod, cross_kv_boundary_batch);
    ...
    load_kv_new(Params const& params,
        ...
        auto [n_block_new_min, n_block_new_max] = BlockMN_t::get_n_block_k_new_store_min_max(
            seqlen_info, split_idx, params.num_splits);
